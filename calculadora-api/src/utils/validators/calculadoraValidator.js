function validadorParametros(numero1, numero2, operacao) {
...
function validaResultado(resultado) {
  // verifica se o resultado é válido
  if (resultado == null || resultado == undefined || resultado == "NaN") {
    throw new Error("Erro de calculo interno resultado nulo ou indefinido!");
  } else {
    return false;
  }
}
